...
fn query_shape_properties() {
    ...
    // The expected response to the query after this set up
    let expected = vec![
        VectorResponse::Shape(shape_1, CanvasShape::Group, FrameTime::ZERO, ShapeType::new("shape"), vec![(CanvasPropertyId::new("shape"), CanvasProperty::Int(42))]),
        VectorResponse::Shape(shape_2, CanvasShape::Group, FrameTime::ZERO, ShapeType::new("shape"), vec![(CanvasPropertyId::new("shape"), CanvasProperty::Int(43)), (CanvasPropertyId::new("brush1"), CanvasProperty::Int(45)), (CanvasPropertyId::new("brush2"), CanvasProperty::Int(49))]),
    ];
...
fn query_layer() {
    ...
    let expected_second = vec![
        ...
        VectorResponse::Shape(shape_3, CanvasShape::Group, FrameTime::ZERO, ShapeType::new("shape"), vec![]),
        VectorResponse::Shape(shape_4, CanvasShape::Group, FrameTime::ZERO, ShapeType::new("shape"), vec![]),
    ];
...
fn query_layer_with_groups() {
    ...
    let expected = vec![
        ...
        VectorResponse::Shape(group_shape, CanvasShape::Group, FrameTime::ZERO, ShapeType::new("shape"), vec![]),
        VectorResponse::StartGroup,
        VectorResponse::Shape(child_1, test_rect(), FrameTime::ZERO, ShapeType::new("shape"), vec![]),
        VectorResponse::Shape(nested_group, CanvasShape::Group, FrameTime::ZERO, ShapeType::new("shape"), vec![]),
        VectorResponse::StartGroup,
        VectorResponse::Shape(nested_child_1, test_ellipse(), FrameTime::ZERO, ShapeType::new("shape"), vec![]),
        VectorResponse::Shape(nested_child_2, test_rect(), FrameTime::ZERO, ShapeType::new("shape"), vec![]),
        VectorResponse::StartGroup,
        VectorResponse::Shape(nested2_child_1, test_ellipse(), FrameTime::ZERO, ShapeType::new("shape"), vec![]),
        VectorResponse::Shape(nested2_child_2, test_rect(), FrameTime::ZERO, ShapeType::new("shape"), vec![]),
        VectorResponse::EndGroup,
        VectorResponse::EndGroup,
        VectorResponse::Shape(child_2, test_ellipse(), FrameTime::ZERO, ShapeType::new("shape"), vec![]),
        VectorResponse::EndGroup,
        VectorResponse::Shape(after_group, test_rect(), FrameTime::ZERO, ShapeType::new("shape"), vec![]),
    ];
...
fn query_layer_frames_returns_shapes_for_correct_frame() {
    ...
    let expected_frame_1 = vec![
        VectorResponse::Layer(layer, vec![]),
        VectorResponse::Shape(shape_1, test_rect(), frame_1_time, ShapeType::new("shape"), vec![]),
    ];
    let expected_frame_2 = vec![
        VectorResponse::Layer(layer, vec![]),
        VectorResponse::Shape(shape_2, test_ellipse(), frame_2_time, ShapeType::new("shape"), vec![]),
    ];
