...
let flo_canvas = (function() {
    ...
    function create_drawing_functions(canvas) {
        ...
        return {
            ...
            layer:              (layer_id)      => { replay.push([layer, [layer_id], layer_id]);                            render.layer(layer_id);                },
            layer_blend:        (layer_id, blend_mode) => { replay.push([layer_blend, [layer_id, blend_mode], layer_id]);   render.layer_blend(layer_id, blend_mode); },
            layer_alpha:        (layer_id, alpha) => { replay.push([layer_alpha, [layer_id, alpha], layer_id]);             render.layer_alpha(layer_id, alpha);   },
