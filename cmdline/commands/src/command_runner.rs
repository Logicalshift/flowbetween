...
///
pub fn flo_run_commands<InputStream>(commands: InputStream) -> impl Stream<Item=FloCommandOutput>
where InputStream: 'static+Stream<Item=FloCommand>+Send {
    // Create the output
...
///
async fn run_commands<InputStream>(commands: InputStream, output_publisher: Publisher<FloCommandOutput>) {
